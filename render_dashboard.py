    ...
    if live_active:
        ...
        for f in live["fixtures"]:
            ...
            cards.append(
                ...
                f'<span class="side-team">proj <b>{f["home_projection"]:.0f}</b> '
                f'({f.get("home_low", 0)}&ndash;{f.get("home_high", 0)}) &middot; '
                ...
                f'<span class="side-team">proj <b>{f["away_projection"]:.0f}</b> '
                f'({f.get("away_low", 0)}&ndash;{f.get("away_high", 0)}) &middot; '
        ...
        live_html = (
            ...
            f'</span></div>'
            f'<p class="lede">Each projection is the average of thousands of simulated '
            f'finishes, and the bracket beside it is the range four of those five times land '
            f'in. Both tighten as matches end. Live totals include provisional bonus, so they '
            f'can run ahead of the official table.</p>'
