...
_Win chances come from simulating the players still to play, drawing their scores from what players actually did this gameweek (forecast error 3.0 pts per starter) and letting teammates move together. They tighten as matches finish, so late in a gameweek they get lopsided quickly._
...
|---|---|---|---|
| chris Purnell | 58 | 58.0 | 0 |
| Jason Parmar | 50 | 50.0 | 0 |
| Ollie Felts | 47 | 47.0 | 0 |
| Piers Black-Hawkins | 46 | 46.0 | 0 |
